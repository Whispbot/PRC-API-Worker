...
namespace PRC_API_Worker
{
    public static class Redis
    {
        ...
        public static bool Init(RedisInitConfig? config = null)
        {
            ...
            try
            {
                ...
                string? redis_host = config?.redis_host ?? Environment.GetEnvironmentVariable("REDIS_HOST");
                string? redis_port = config?.redis_port ?? Environment.GetEnvironmentVariable("REDIS_PORT");
                string? redis_password = config?.redis_password ?? Environment.GetEnvironmentVariable("REDIS_PASSWORD");
